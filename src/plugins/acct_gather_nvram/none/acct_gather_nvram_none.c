/*****************************************************************************\
 *  acct_gather_nvram_none.c - slurm NVRAM accounting plugin for none.
 *****************************************************************************
...
/*   acct_gather_nvram_none
 * This plugin does not initiate a node-level thread.
 * It is the acct_gather_nvram stub.
 */
 ...
 */
const char plugin_name[] = "AcctGatherNVRAM NONE plugin";
const char plugin_type[] = "acct_gather_nvram/none";
...
extern int acct_gather_nvram_p_get_data(acct_gather_data_t *data)
{
	return SLURM_SUCCESS;
}
